...
export default {
  ...
  async mounted() {
    ...
    if (!this.scenario3) {
      try {
        const twiResponse = await axios.get(`${API_PREFIX}/api_twi_state_city/${this.scenario1}/${this.location}`);
      ...
      try {
        const sudoResponse = await axios.get(`${API_PREFIX}/api_sudo_state_city/${this.scenario2}/${this.location}`);
      ...
      try {
        const twiResponse1 = await axios.get(`${API_PREFIX}/api_twi_state_city/${this.scenario1}/${this.location}`);
      ...
      try {
        const twiResponse2 = await axios.get(`${API_PREFIX}/api_twi_state_city/${this.scenario2}/${this.location}`);
        // this.center = twiResponse.data.state;
      ...
      try {
        const twiResponse3 = await axios.get(`${API_PREFIX}/api_twi_state_city/${this.scenario3}/${this.location}`);
        // this.center = twiResponse.data.state;
  ...
  methods: {
    ...
    //     try {
    //       const new_twiResponse = axios.get(`${API_PREFIX}/api_twi_state_city/${new_scenario1}/${new_state}`);
    ...
    //     try {
    //       const new_sudoResponse = axios.get(`${API_PREFIX}/api_sudo_state_city/${new_scenario2}/${new_state}`);
