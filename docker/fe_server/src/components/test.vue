...
export default {
  ...
  mounted() {
    this.initMap();
    Promise.all([
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/newsouthwales'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/victoria'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/queensland'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/southaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/westernaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/tasmania'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/australiancapitalterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/northernterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/unemployment/offshoreterritories'),

      axios.get(API_PREFIX + '/api_twi_state_total/agism/newsouthwales'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/victoria'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/queensland'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/southaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/westernaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/tasmania'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/australiancapitalterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/northernterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/agism/offshoreterritories'),

      axios.get(API_PREFIX + '/api_twi_state_total/sexism/newsouthwales'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/victoria'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/queensland'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/southaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/westernaustralia'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/tasmania'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/australiancapitalterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/northernterritory'),
      axios.get(API_PREFIX + '/api_twi_state_total/sexism/offshoreterritories')
    ])
      .then(responses => {
